	...
	<td class="text-right">
		<div class="action_dropdown btn-group">
			...
			<ul class="dropdown-menu dropdown-menu-end">
				<li>
					<a class="dropdown-item" href="{{ route('admin.products.categories.edit', ['id' => $row->id]) }}">
						<i class="fas fa-edit text-primary"></i>
						<span class="status">Edit</span>
					</a>
				</li>
				<li>
					<a class="dropdown-item delete_confirm" href="{{ route('admin.products.categories.delete', ['id' => $row->id]) }}">
